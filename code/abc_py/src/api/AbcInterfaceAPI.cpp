...
void initAbcInterfaceAPI(py::module &m)
{
        py::class_<PROJECT_NAMESPACE::AbcInterface>(m, "AbcInterface")
            ...
            .def("resub", &PROJECT_NAMESPACE::AbcInterface::resub, "resub action",
                 ...
                 py::arg("l") = false, py::arg("z") = false, py::arg("v") = false)
            ...
            /* added by zhihai 20221208 */
            .def("resyn2", &PROJECT_NAMESPACE::AbcInterface::resyn2)
            .def("strash", &PROJECT_NAMESPACE::AbcInterface::strash, "strash opeartor")
            .def("dch", &PROJECT_NAMESPACE::AbcInterface::dch, "dch operator",
                 py::arg("v") = true)
            .def("If", &PROJECT_NAMESPACE::AbcInterface::If, "If operator",
                 py::arg("C") = 12, py::arg("v") = true)
            .def("lutpack", &PROJECT_NAMESPACE::AbcInterface::lutpack, "lutpack operator",
                 py::arg("v") = false)
            .def("mfs2", &PROJECT_NAMESPACE::AbcInterface::mfs2, "mfs2 operator",
                 py::arg("W") = 4, py::arg("M") = 5000, py::arg("p") = 0, py::arg("l") = false, py::arg("v") = true, py::arg("w") = true)
            .def("getStats", &PROJECT_NAMESPACE::AbcInterface::getStats, "Get the graph stats from the ABC framework`");
        /* added by zhihai 20221208 */
