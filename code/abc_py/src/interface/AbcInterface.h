...
public:
    ...
    IntType fanin0()
    {
        AssertMsg(hasFanin0(), "The node does not has fanin 0!\n");
        return _fanin0;
    }
    ...
    IntType fanin1()
    {
        AssertMsg(hasFanin1(), "The node does not has fanin 1!\n");
        return _fanin1;
    }
...
public:
    ...
    /// @return if successful
    bool resub(IntType k = -1, IntType n = -1, IntType f = -1, bool l = false, bool z = false, bool v = false);
    ...
    bool strash();
    bool dch(bool v = true);
    bool If(IntType C = 12, bool v = true);
    bool lutpack(bool v = false);
    bool mfs2(IntType W = 4, IntType M = 5000, IntType p = 0, bool l = false, bool v = true, bool w = true);
    std::string getStats();
    /// @brief resyn2 "b; rw; rf; b; rw; rwz; b; rfz; rwz; b"
    bool resyn2();
    /* added by zhihai 20221208 */
    /*------------------------------*/
    /* Baselines                    */
